                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="d-flex mb-3">
                                        ...
                                        <form class="w-100">
                                            <textarea class="form-control pe-4 fs-3 lh-1 border-0" rows="4" placeholder="Что у вас нового?" autofocus></textarea>
                                        </form>
                                    </div>
                                ...
                                <div class="modal-footer row justify-content-between">
                                    <form id="addPost_form" enctype="multipart/form-data">
                                        <div class="col-lg-8 align-self-end">
                                            <input type="button" id="addPost" onclick="addArticle()" class="btn btn-success-soft" value="Опубликовать"></form>
                                </div>
                            </div>
                        </div>
                    </div>
