...
@section('content')
                            ...
                            <div class="d-sm-flex align-items-start text-center text-sm-start">
                                <div>
                                    ...
                                    <div class="avatar avatar-xxl mt-n5 mb-3">
                                        <img id="user_avatar" class="avatar-img rounded-circle border border-white border-3" src="{{auth()->user()->img}}" alt="">
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            let img = document.getElementById("user_avatar").src;
            ...
            fetch('/showMyPosts', {
                ...
                .then(function (result){
                    ...
                    for (let item of result){
                        MyPosts[i] = [item.id, item.content, item.img, item.author_id, item.created_at]
                        let post = MyPosts[i];
                        html += `
                    <div class="card mb-3">
                    <!-- Card header START -->
                    <div class="card-header border-0 pb-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <!-- Avatar -->
                                <div class="avatar avatar-story me-2">
                                    <a href="#!"> <img class="avatar-img rounded-circle" src="${img}" alt=""> </a>
                                </div>
                                <!-- Info -->
                                <div>
                                    <div class="nav nav-divider">
                                        <h6 class="nav-item card-title mb-0"> <a href="#!"> ${name+' '+lastname} </a></h6>
                                        <span class="nav-item small"> 2hr</span>
                                    </div>
                                    <p class="mb-0 small">${about}</p>
                                </div>
                            </div>
                            <!-- Card feed action dropdown START -->
                            <div class="dropdown">
                    ...
                    <div class="card-body">
                        <p>${post[1]}</p>
                        <!-- Card img -->
                        <img class="card-img" style="height: 500px" src="${post[2]}" alt="">
                        <!-- Feed react START -->
                                <!-- Card share action dropdown menu -->
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardShareAction8">
