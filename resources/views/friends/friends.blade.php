                    ...
                    <div class="card mb-2 col-md-11 ">
                        <div class="card-header p-2">
                            <div class="d-flex align-items-start justify-content-start">
                                <div class="d-flex align-items-start col-md-8" style="max-height: 60px; overflow-x:hidden;">
                                    <!-- Avatar -->
                                    <div class="avatar me-2">
                                        <a href='/profile/{{$application->id}}'><img class="avatar-img rounded-circle" src="{{asset($application->img)}}" alt=""></a>
                                    </div>
                                    <!-- Info -->
                                    <div>
                                        <div class="nav nav-divider pt-2">
                                            <a href='/profile/{{$application->id}}'><h6 class="nav-item card-title mb-0">{{$application->name.' '.$application->lastname}}</h6>
                                            </a>
                                        </div>
